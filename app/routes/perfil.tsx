          ...
          <CardContent>
            <form className="space-y-5" onSubmit={handleProfileSubmit}>
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <Button type="button" variant="outline" onClick={openEmailModal}>
                  {(personalForm['changeEmail'] as string | undefined) ?? 'Alterar e-mail'}
                </Button>
                <Button type="button" variant="outline" onClick={() => setPasswordModalOpen(true)}>
                  {(personalForm['changePassword'] as string | undefined) ?? 'Alterar senha'}
                </Button>
                <Button type="button" variant="destructive" onClick={() => setDeleteModalOpen(true)}>
                  {(personalForm['deleteAccount'] as string | undefined) ?? 'Excluir conta'}
                </Button>
                {profileStatus === 'saved' && (
